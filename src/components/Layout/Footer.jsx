    ...
    <footer className="bg-white border-t border-gray-200 py-6 mt-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 md:gap-16">
            <div>
              ...
              <ul className="space-y-2">
                <li><Link to="/workouts" className="text-sm text-gray-600 hover:text-primary">Workouts</Link></li>
                <li><Link to="/nutrition" className="text-sm text-gray-600 hover:text-primary">Nutrition</Link></li>
                <li><Link to="/goals" className="text-sm text-gray-600 hover:text-primary">Goals</Link></li>
              </ul>
            </div>
        ...
        <div className="mt-8 pt-4 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
          ...
          <p className="mt-2 md:mt-0 text-sm text-gray-500 flex items-center">
            Made with <Heart size={14} className="mx-1 text-error" /> by FitTrack Team
          </p>
        </div>
      </div>
    </footer>
